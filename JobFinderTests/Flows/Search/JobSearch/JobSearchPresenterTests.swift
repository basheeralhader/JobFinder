...
class JobSearchPresenterTests: XCTestCase {

    var view = JobSearchMock()
    var presenter: JobSearchPresenter!
    
    override func setUp() {
        presenter = JobSearchPresenter(with: view, useCase: ProvidersUseCase())
    }
